...
$(function () {
  ...
  $(".mil-tabs-right-nav a").on("click", function () {
    $(".mil-tabs-right-nav a").removeClass("mil-active");
    $(this).toggleClass("mil-active");
  });

  $(".mil-tabs-left-nav-third a").on("click", function () {
    $(".mil-tabs-left-nav-third a").removeClass("mil-active");
    $(this).toggleClass("mil-active");
  });
